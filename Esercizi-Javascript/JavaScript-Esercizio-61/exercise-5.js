  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      if (persons.some((index) => index.id === personId)) {
        ...
        reject(new Error(`There is no person with that index`))
      }
    }, 1000);
  })
}
...
/*
verrà eseguita prima quella con 1000 ms
poi verrà eseguita solo
quella più rapida delle due, quindi la seconda con 500ms
 */